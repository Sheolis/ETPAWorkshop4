...
init(){
  ...
  arr_appearance_player = [['p_0',4,4,0],['p_1',29,33,0],['p_2',148,294,0],['p_3',148,294,0]];// [key, height,width, stopframe]
...
preload(){
    ...
    this.load.spritesheet('p_1','assets/p_1.png',{frameWidth: 30, frameHeight: 32});
    this.load.spritesheet('p_2','assets/p_2.png',{frameWidth: 148, frameHeight: 197});
    this.load.spritesheet('p_3','assets/p_3.png',{frameWidth: 148, frameHeight: 294});
}
